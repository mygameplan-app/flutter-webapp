...
Future<ImageFileHolder> _getMobileImage() async {
...
Future<ImageFileHolder> _getDesktopImage() {
...
Future<ImageFileHolder> uploadImageToDevice() async {
...
Future<String> uploadFileToCloudStorage(html.File file) async {
